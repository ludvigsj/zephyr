...
#     - wait for being provisioned
#     - call bt_mesh_comp_data_set() to prepare for Composition Data change
#     - wait for comp_swap callback
...
RunTestFlash mesh_prov_pst_pb_remote_ncrp \
	...
	prov_device_pb_remote_server_ncrp -flash_erase
...
RunTestFlash mesh_prov_pst_pb_remote_ncrp \
	...
	prov_device_pb_remote_server_ncrp_comp_swap
